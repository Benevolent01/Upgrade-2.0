...
module.exports = {
  ...
  // first string opt
  slash_opgg_fo: {name: "summoner-name", description: "Enter your summoner name", required: true},
  // second string opt
  slash_opgg_so: {name: "server", description: "Select your region", required: true, options: VALID_SERVERS},

  // mastery-gg
  slash_mast_gg: "mastery-gg",
  slash_mast_desc: "Find out the 25 top highest mastery champions of said player",

  // champ-quote
  slash_cq: "champ-quote",
  slash_cq_desc: "Randomly pick one of your favourite champion's quote",
  slash_cq_fo: {name: "champion-name", description: "Your champion's name", required: true},
  ...
  slash_bet_fo: {name: "amount", desc: "Select the amount you want to bet", required: true},
  ...
  slash_hangman_str_opts: {
    ...
    opts: [
      ...
      {name: "GUESS", value: "guess", desc: "Make a guess by typing a character!"},
    ],
  },
